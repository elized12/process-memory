...
LinuxSmartMemoryFinder::LinuxSmartMemoryFinder(const process::memory::LinuxMemoryFinder& finder) :
    _finder(finder)
{

}

std::vector<process::memory::MemoryRecord> LinuxSmartMemoryFinder::findValues(
    int pid,
